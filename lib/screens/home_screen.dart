  ...
  // import 'farm_list_screen.dart'; // 이 화면은 이제 홈에서 직접 사용하지 않습니다.
  import 'nearby_farm_screen.dart'; // ⭐️ 수정: 주변 농장 화면 import
              ...
              Expanded(
                child: _buildFeatureCard(
                  ...
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (_) => const NearbyFarmScreen()),
                    );
                  },
                ),
              ),
