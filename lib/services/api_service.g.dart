...
class _ApiService implements ApiService {
  ...
  @override
  Future<JwtToken> login(LoginRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _options = _setStreamType<JwtToken>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    late JwtToken _value;
    try {
      _value = JwtToken.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<User> updateNickname(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
